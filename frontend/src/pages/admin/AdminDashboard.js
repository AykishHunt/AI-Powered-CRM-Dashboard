...
import { Users, Tag, Clock, ShieldCheck } from "lucide-react"
...
export default function AdminDashboard() {
  ...
  return (
    <DashboardLayout>
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-br from-violet-600/20 via-blue-600/15 to-transparent pointer-events-none" />
        <div className="absolute -top-16 -right-16 w-48 h-48 bg-violet-500/10 rounded-full blur-2xl pointer-events-none" />
        <div className="relative flex items-start justify-between">
          <div>
            <p className="text-xs font-semibold tracking-widest text-violet-400/70 uppercase mb-2">Admin Panel</p>
            <h1 className="text-2xl font-semibold text-white tracking-tight">Admin Dashboard</h1>
            <p className="text-sm text-gray-400 mt-1">Full system overview across all users.</p>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-8">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-500">Total Contacts</p>
        ...
        {Object.entries(stats?.byTag || {}).map(([tag, count], i) => (
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="relative p-5 rounded-xl bg-white dark:bg-[#111520] border border-gray-100 dark:border-white/[0.07] shadow-sm overflow-hidden group hover:border-violet-200 dark:hover:border-violet-500/20 transition-colors"
          >
            <div className="flex items-center justify-between mb-4">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-violet-500 to-blue-600 flex items-center justify-center text-white font-semibold text-sm flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">
                  ...
                  <span className="font-medium text-gray-600 dark:text-gray-300">
                    {stats.lastEdited.userId?.name || "Unknown"}
                  </span>
                </p>
              </div>
            </div>
